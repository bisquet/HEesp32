...
El kernel de Linux bloquea el acceso a los puertos seriales (/dev/ttyUSB0). Para que PlatformIO pueda flashear el ESP32, debes otorgar permisos a tu usuario añadiéndolo al grupo dialout:

Bash
sudo usermod -aG dialout $USER
⚠️ ALERTA CRÍTICA: Debes CERRAR SESIÓN y volver a entrar (o reiniciar el equipo) para que la inclusión en el grupo dialout surta efecto. De lo contrario, la compilación fallará.
...
Dentro de la raíz del proyecto clonado, ejecuta:
...
lock <MAC> <CANAL>: Fija la antena en el objetivo para captura pasiva.
